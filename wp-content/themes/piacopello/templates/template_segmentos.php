<?php /* Template Name: segmentos */
set_query_var('ENTRY', 'home');
get_header();
$homeid = get_option("page_on_front");
$getid = get_the_ID();
?>
<section class="indulbanner" style="background-image:url(<?php echo get_the_post_thumbnail_url(); ?>)">
        ...
        <div class="detalles__flex">
            <div class="detalles__left">
                ...
                <div class="detallesItem">
                    <img src="<?php echo $dd["imagen"]; ?>">
                    <div>
                        <?php echo $dd["contenido"]; ?>
                    </div>
                </div>
                            <?php
                        }
            ...
            <div class="detalles__right">
                <div><?php echo get_field("contenido_detalles"); ?></div>    
                <img src="<?php echo get_field("imagen_detalles"); ?>">
            </div>
        </div>
    </div>
</section>
...
<section class="profesionales">
    <div class="x-container">
        <h2>Profesionales Certificados: </br><b>Nuestra Garantía de Calidad</b></h2>
        <div class="caruseltestimonialesProfesionales">
            <div class="swiper-container">
                <div class="swiper-wrapper">
                    <?php 
                        $profesionales = get_field("profesionales", $getid);
                        if ($profesionales) {
                    ...
                    <div class="swiper-slide">
                        <div class="testimonialitem">
                            <div class="imagen">
                                <img src="<?php echo $profesional["imagen"]; ?>">
                            </div>
                            <div class="content">                                
                                <div class="autor">
                                    <div class="re"><?php echo $profesional["nombre"]; ?><b><?php echo $profesional["cargo"]; ?></b></div>                                    
                                    <div class="ma"><?php echo $profesional["contenido"]; ?></div>
                                </div>
                                    ...
                                    <?php 
                                        ...
                                        if ($certificaciones) {
                                            foreach ($certificaciones as $certificacion) {
                                                ?>
                                    <a href="<?php echo $certificacion["link"]; ?>" donwload>
                                        <img src="<?php echo $certificacion["imagen"]; ?>" alt="certificado">
                                        <div class="content">
